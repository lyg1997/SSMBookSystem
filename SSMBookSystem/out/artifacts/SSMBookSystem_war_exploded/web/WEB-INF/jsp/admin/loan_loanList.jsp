                ...
                <c:forEach items="${loanRecordList}" var="item">
                    <tr data-id="${item.id}">
                        ...
                        <td>${item.tbUser.telnum}</td>
                            <%--使用jsp将long类型的时间戳进行格式化--%>
                            <%--       <td>
                                       <jsp:useBean id="recorddate" class="java.util.Date"/>
                                       <jsp:setProperty name="recorddate" property="time" value="${item.recorddate}"/>
                                       <fmt:formatDate value="${recorddate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                   </td>
                                   <td>
                                       <jsp:useBean id="backdate" class="java.util.Date"/>
                                       <jsp:setProperty name="backdate" property="time" value="${item.backdate}"/>
                                       <fmt:formatDate value="${backdate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                   </td>--%>
